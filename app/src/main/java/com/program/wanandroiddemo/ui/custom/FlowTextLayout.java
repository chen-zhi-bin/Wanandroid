...
public class FlowTextLayout extends ViewGroup {
    ...
    //后续需要转单位，目前是px不适配
    public static final int DEFAULT_HORIZONTAL_MARGIN = SizeUtils.dip2px(BaseApplication.getAppContext(),5);
    public static final int DEFAULT_Vertaical_MARGIN = SizeUtils.dip2px(BaseApplication.getAppContext(),5);
    public static final int DEFAULT_BARDOR_RADIUS = SizeUtils.dip2px(BaseApplication.getAppContext(),5);
...
//            textView.setBackgroundDrawable(drawable);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mBottom = fistChild.getMeasuredHeight()+(int)mVertaicalMargin;
        ...
        for (List<View> line : mLines) {
            for (View view : line) {
                ...
                view.layout(currentLeft,currentTop,currentRight, mBottom);
    ...
    public int getAllItemFinalBottom() {
        return mBottom;
    }
